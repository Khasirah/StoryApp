...
import dev.peppo.storyapp.DataDummy
import dev.peppo.storyapp.MainDispatcherRule
import dev.peppo.storyapp.data.StoryRepository
import dev.peppo.storyapp.data.remote.response.story.ListStoryItem
import dev.peppo.storyapp.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = PagingStoriesAdapter.DIFF_CALLBACK,
